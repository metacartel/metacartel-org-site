...
export const EcosystemList: React.FC<EcosystemListProps> = ({
  color = "brand.sun",
}) => {
  ...
  useEffect(() => {
    ...
    ;(async () => {
      ...
      const slicedData = filteredData.slice(
        0,
        pathname === "/" ? homepageSlice : filteredData.length
      )
  ...
  return (
    <Box w="100%">
      <Grid
        templateColumns="repeat(auto-fit, minmax(min(170px, 100%), 1fr))"
        columnGap={[1, 2, 4, 8, 16]}
        rowGap={10}
        placeItems="center"
      >
